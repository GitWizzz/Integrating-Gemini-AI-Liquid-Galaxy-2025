...
const GeminiChat = () => {
        ...
        p.map((c) =>
          c.id === chatId
            ? {
                ...
                title: c.title === "New Chat" ? text.slice(0, 28) : c.title,
              }
            : c
        )
      );
  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      {/* SIDEBAR */}
      <aside
        className={`fixed md:static z-50 md:z-auto w-72 h-full border-r bg-gray-50 flex flex-col p-4 transition-transform duration-300 ${
      ...
      >
        ...
        <button
          onClick={newChat}
          className="mb-4 py-2.5 rounded-lg bg-purple-600 text-white text-sm hover:bg-purple-700 transition"
        >
          + New Chat
        </button>

        <div className="border-t pt-3 mb-2 text-xs font-semibold text-gray-400">
          RECENT CHATS
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="flex items-center justify-between px-6 py-3 border-b">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-[#4D2E64]">
              Effortless Support
            </span>
        ...
        {!activeChat && (
          <div className="flex-1 flex flex-col items-center text-center pt-8">
            ...
            <h2 className="text-3xl font-bold text-[#824b9c]">
            ...
            <div className="mt-10 w-full max-w-sm space-y-3">
              <QuickCard
                ...
                icon="https://img.icons8.com/?size=100&id=2UdOcs6ysdJo&format=png&color=AB5CC9"
              />
              <QuickCard
                title="Document Finder"
                icon="https://img.icons8.com/?size=100&id=QxNDCQCA0COh&format=png&color=AB5CC9"
              />
            </div>
          </div>
        )}
        ...
        {activeChat && (
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {typing && (
              <div className="text-sm text-gray-400">Gemini is typing…</div>
            )}
          </div>
        )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-5 w-full max-w-sm mx-4">
            ...
            <div className="mt-4 flex justify-end gap-3">
              ...
              <button
                onClick={saveApiKey}
                className="px-4 py-1.5 bg-purple-600 text-white text-sm rounded"
              >
                Save
              </button>
            </div>
